...
def calculate_future_value(monthly_investment, yearly_interest, years):
    ...
    # I added the / 100. to convert the interest into a percentage
    ...
    for i in range(0, months):
        ...
        # print()
        # print("------------------------------")
        # print("Monthly Investment:", i, " ", monthly_investment)
        # print("Future Value:", i, " ", future_value)
        # print("Monthly Interest:", i, " ",  monthly_interest)
        # print("------------------------------")
